...
Add compute capacity to your {{site.data.keyword.satellitelong}} location to set up {{site.data.keyword.redhat_openshift_notm}} clusters or use [{{site.data.keyword.satelliteshort}}-enabled {{site.data.keyword.cloud_notm}} services](/docs/satellite?topic=satellite-managed-services).
{: shortdesc}
