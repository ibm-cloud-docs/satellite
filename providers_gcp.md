...
Review the following host requirements that are specific to hosts are created in Google Cloud Platform (GCP). 
{: shortdesc}
...
4. From the GCP **Compute Engine** dashboard, select **Instance templates**. 
