...
Use the {{site.data.keyword.satelliteshort}} console to create a Connector for a secure connection between a remote location and {{site.data.keyword.cloud_notm}}.
{: shortdesc}
