...
Default endpoints are created for your location control plane and {{site.data.keyword.satelliteshort}}-enabled services, accessible only from the {{site.data.keyword.cloud_notm}} private network.
{: shortdesc}
...
| `satellite-logdna-<location_ID>` | Allows logs for your location to be sent to your {{site.data.keyword.logs_full}} instance. | Cloud | One per location |
| `satellite-logdnaapi-<location_ID>` | Allows your location to communicate with the {{site.data.keyword.logs_full}} API. | Cloud | One per location |
