...
# Non Red Hat CoreOS hosts in Tokyo (jp-tok): Requred outbound connectivity
{: #reqs-host-network-outbound-tok}

Review the following network requirements for outbound connectivity for non Red Hat CoreOS (RHCOS) hosts in the Tokyo (jp-tok) region.
{: shortdesc}
