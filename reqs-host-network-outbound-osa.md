...
# Non Red Hat CoreOS hosts in Osaka (jp-osa): Requred outbound connectivity
{: #reqs-host-network-outbound-osa}

Review the following network requirements for outbound connectivity for non Red Hat CoreOS (RHCOS) hosts in the Osaka (jp-osa) region.
{: shortdesc}
