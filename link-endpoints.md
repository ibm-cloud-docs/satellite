...
| `satellite-containersApi` | Allows your {{site.data.keyword.satelliteshort}} location to communicate with the OpenShift Data Foundation service. | `cloud` | One per location |
