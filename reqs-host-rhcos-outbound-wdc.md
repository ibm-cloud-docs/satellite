...
# CoreOS enabled locations in Washington D.C.
...
Review the following outbound network requirements for RHEL and RHCOS hosts for use with CoreOS enabled locations in the Washington D.C. (`us-east`) region.
