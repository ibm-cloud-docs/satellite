...
Continue to [set up cluster groups](/docs/satellite?topic=satellite-setup-clusters-satconfig-groups) and [register clusters with Satellite Config](/docs/satellite?topic=satellite-setup-clusters-satconfig&interface=ui/docs/satellite?topic=satellite-register-openshift-clusters).
