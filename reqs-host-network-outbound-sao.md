...
# Non-CoreOS enabled locations in Sao Paulo
...
Review the following outbound network requirements for RHEL hosts for use with non-CoreOS enabled locations in the Sao Paulo (`br-sao`) region.
