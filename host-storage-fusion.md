...
IBM Storage Fusion is a container-native data platform for {{site.data.keyword.redhat_openshift_full}} with enterprise-grade storage and data protection for mission-critical workloads.
{: shortdesc}
...
:   See the [IBM Storage Fusion documentation](https://www.ibm.com/docs/en/storage-fusion){: external} for deployment steps.
