...
Track how users and applications interact with {{site.data.keyword.satellitelong_notm}} by using {{site.data.keyword.logs_full_notm}}.
{: shortdesc}
...
| `subscription.list` | A list of assignments is retrieved. |
...
{{site.data.keyword.satellitelong_notm}} events are automatically forwarded to the {{site.data.keyword.logs_full_notm}} instance in the region that manages your {{site.data.keyword.satelliteshort}} location.
{: shortdesc}
