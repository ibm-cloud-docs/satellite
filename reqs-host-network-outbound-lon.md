...
# Non-CoreOS enabled locations in London
...
Review the following outbound network requirements for RHEL hosts for use with non-CoreOS enabled locations in the London (`eu-gb`) region.
