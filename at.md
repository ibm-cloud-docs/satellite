...
{{site.data.keyword.satelliteshort}} location and global events are available in the {{site.data.keyword.at_full_notm}} instance that is in the same region as the location is managed from.
