...
| Term | Description |
| ------ | ------------------------- |
| {{site.data.keyword.satelliteshort}} location | A {{site.data.keyword.satelliteshort}} location is a representation of an environment in your infrastructure provider, such as an on-prem data center or cloud. Locations can be made up of communications endpoints such as a Docker container, or of compute resources called hosts, which are used to form from separate availability zones out of a given x86 infrastructure.  To get started with {{site.data.keyword.satelliteshort}}, consider first your goals: /n - For a full {{site.data.keyword.satelliteshort}} location that supports on premise cloud services, consider your infrastructure and then create a location. After your location is created and hosts have been attached, you can utilize {{site.data.keyword.cloud_notm}} services to run workloads in your own environment. See [Understanding {{site.data.keyword.satelliteshort}} locations](/docs/satellite?topic=satellite-location-host). /n - For enabling only secure communications between your {{site.data.keyword.satelliteshort}} location and {{site.data.keyword.cloud_notm}}, you can create a hostless location utilizing only {{site.data.keyword.satelliteshort}} Connector Agent. |
| {{site.data.keyword.satelliteshort}} Connector | A {{site.data.keyword.satelliteshort}} Connector is a deployment model that enables only the secure communications from {{site.data.keyword.cloud_notm}} to on-prem resources via a light weight container deployed by the client on their own Docker hosts. This option brings all the security and auditability of {{site.data.keyword.satelliteshort}} communication, but with much lower resources required. |
