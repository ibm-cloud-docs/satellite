...
??DO WE NEED TO INCLUDE WINDOWS in this list now and we have Windows (and Docker) agents??

See [{{site.data.keyword.satelliteshort}} Connector overview](/docs/satellite?topic=satellite-understand-connectors). |
