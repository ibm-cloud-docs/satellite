...
# Frankfurt RHCOS host requirements
{: #reqs-host-rhcos-outbound-fra}

Review the following network requirements for outbound connectivity for Red Hat CoreOS (RHCOS) hosts for Red Hat CoreOS enabled locations in the Frankfurt (`eu-de`) region. 
{: shortdesc}
