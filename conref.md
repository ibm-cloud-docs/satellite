...
See [View your usage](/docs/account?topic=account-viewingusage#viewingusage) and [Set spending notifications](/docs/support?topic=support-spending) for general {{site.data.keyword.cloud_notm}} account guidance.
