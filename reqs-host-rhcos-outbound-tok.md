...
# CoreOS enabled locations in Tokyo 
...
Review the following outbound network requirements for RHEL and RHCOS hosts for use with CoreOS enabled locations in the Tokyo (`jp-tok`) region.
{: #host-out-rhcos-tok}
