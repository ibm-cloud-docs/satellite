...
The following network requirements are for outbound connectivity for Red Hat Enterprise Linux (RHEL) hosts for use with non Red Hat CoreOS enabled.
{: shortdesc}
...
You can [download a copy of these requirements](https://cloud.ibm.com/media/docs/downloads/satellite/non-rhcos-toronto.csv){: external}.
{: tip}
...
:    * Destination IP addresses: N/A
     * Destination hostnames: `s3.ca-tor.cloud-object-storage.appdomain.cloud` and `*.s3.ca-tor.cloud-object-storage.appdomain.cloud`
