...
| Date | Description |
| ---- | ----------- |
| 29 June 2021 | **New!** General availability of the {{site.data.keyword.satelliteshort}} storage templates. For more information about storage templates, see [Understanding storage templates](/docs/satellite?topic=satellite-sat-storage-template-ov). | 
