...
| Date | Description |
| ---- | ----------- |
| 06 May 2021 | **New! Spectrum Scale CSI driver template**: You can use the IBM Spectrum Scale Container Storage Interface (CSI) driver to create persistent storage for stateful applications running in Satellite clusters. For more information, see the [IBM Spectrum Scale driver documentation](/docs/satellite?topic=satellite-config-storage-spectrum-scale). |
