...
Learn about {{site.data.keyword.satellitelong_notm}} architecture, its components, how your workloads are isolated from other tenants, and the external services that {{site.data.keyword.satelliteshort}} depends on.
{: shortdesc}
...
![{{site.data.keyword.satelliteshort}} for IBM Cloud service architecture](/images/sat_architecture.svg "{{site.data.keyword.satelliteshort}} service architecture"){: caption="{{site.data.keyword.satelliteshort}} service architecture" caption-side="bottom"}
...
|-----------------|-----------------------|
|{{site.data.keyword.satelliteshort}} Link tunnel|The {{site.data.keyword.satelliteshort}} Link tunnel server creates a secure Transport Layer Security (TLS) connection to the {{site.data.keyword.satelliteshort}} Link tunnel client that runs on the control plane nodes in your {{site.data.keyword.satelliteshort}} location. Three tunnels are created between the tunnel server and the connector to support redundancy across the three availability zones of your location. All communication that leaves and enters your location is proxied by the Link tunnel server, and the connection metadata is captured and monitored by {{site.data.keyword.IBM_notm}} to detect malicious activity. To control the network connections between the workloads that run in your location and the {{site.data.keyword.cloud_notm}} multizone metro that manages your location, create {{site.data.keyword.satelliteshort}} Link endpoints. For more information, see [Connecting your {{site.data.keyword.satelliteshort}} location and {{site.data.keyword.cloud_notm}} with endpoints](/docs/satellite?topic=satellite-link-location-cloud).  |
...
{: summary="Overview of the {{site.data.keyword.satelliteshort}} management plane components"}
{: class="simple-tab-table"}
{: caption="Overview of {{site.data.keyword.satelliteshort}} management plane components." caption-side="bottom"}
{: #master-components}
...
{: summary="Overview of the {{site.data.keyword.satelliteshort}} control plane node components"}
{: class="simple-tab-table"}
{: caption="Overview of {{site.data.keyword.satelliteshort}} control plane node components." caption-side="bottom"}
