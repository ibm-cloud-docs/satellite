...
# NetApp ONTAP-NAS storage for {{site.data.keyword.satellitelong_notm}} clusters
{: #storage-netapp-ontap-nas}

Set up [NetApp ONTAP-NAS storage](https://docs.netapp.com/us-en/netapp-solutions-containers/openshift/os-trident-ontap-nfs.html){: external} for.
{: shortdesc}
