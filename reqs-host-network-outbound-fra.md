...
# Non-CoreOS enabled locations in Frankfurt
...
Review the following outbound network requirements for RHEL hosts for use with non-CoreOS enabled locations in the Frankfurt (`eu-de`) region.
