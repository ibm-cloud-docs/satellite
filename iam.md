...
- [Other services](#iam-resource-services), like {{site.data.keyword.openshiftlong_notm}} clusters and [{{site.data.keyword.satelliteshort}}-enabled {{site.data.keyword.cloud_notm}} service](/docs/satellite?topic=satellite-managed-services)s.
...
- Service-to-service authorization in IAM for any [{{site.data.keyword.satelliteshort}}-enabled {{site.data.keyword.cloud_notm}} service](/docs/satellite?topic=satellite-managed-services)s that you add to your location.
