...
1. Search for your question and post in the {{site.data.keyword.cloud_notm}} [Slack](https://join.slack.com/t/ibm-cloud-success/shared_invite/zt-2p5zqh275-FL8XUSEmn_vvAJZzrHqYcA){: external}, in the `#satellite` channel.
