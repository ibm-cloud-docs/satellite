...
# CoreOS enabled locations in Madrid
...
Review the following outbound network requirements for RHEL and RHCOS hosts for use with CoreOS enabled locations in the Madrid (`eu-es`) region. 
