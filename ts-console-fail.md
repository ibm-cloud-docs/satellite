...
# Why can't I access the {{site.data.keyword.redhat_openshift_notm}} console without a virtual private network (VPN) on the virtual private cloud (VPC)?
{: #ts-console-fail}
