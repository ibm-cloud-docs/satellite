...
# Non-CoreOS enabled locations in Dallas
...
Review the following outbound network requirements for RHEL hosts for use with non-CoreOS enabled locations in the Dallas (`us-south`) region.
