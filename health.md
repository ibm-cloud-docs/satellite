...
### Autoresolver to monitor and resolve location alerts
{: #autoresolver}

When you create a {{site.data.keyword.satelliteshort}} location and set up the location control plane, the autoresolver automatically monitors and resolves certain alerts for issues with your location setup and host infrastructure. The following table describes different scenarios and the actions that the {{site.data.keyword.satelliteshort}} autoresolver takes to address the scenarios.
{: shortdesc}

| Scenario | Autoresolver Action |
| --- | --- |
...
{: caption="Autoresolver actions to address certain scenarios." caption-side="top"}
...
When you set up a {{site.data.keyword.satelliteshort}} location, {{site.data.keyword.cloud_notm}} monitors the host and reports back statuses that you can use to keep your location healthy. For more information, see [Autoresolver to monitor and resolve location alerts](/docs/satellite?topic=satellite-service-architecture#autoresolver). For troubleshooting help, see [Debugging location health](/docs/satellite?topic=satellite-ts-locations).
{: shortdesc}
...
When you add hosts to a {{site.data.keyword.satelliteshort}} location, {{site.data.keyword.cloud_notm}} monitors the host and reports back statuses that you can use to keep your hosts healthy. For more information, see [Autoresolver to monitor and resolve location alerts](/docs/satellite?topic=satellite-service-architecture#autoresolver). For troubleshooting help, see [Debugging host health](/docs/satellite?topic=satellite-ts-hosts).
{: shortdesc}
