...
All endpoint traffic is encrypted by default. You can provide your own certificates for TLS or HTTPS endpoints to implement source and destination authentication for one or both connections.
{: shortdesc}
