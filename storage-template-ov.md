...
| --- | --- | --- | --- | --- |
| [AWS EBS CSI Driver](/docs/satellite?topic=satellite-storage-aws-ebs-csi-driver) | `aws-ebs-csi-driver` | Version: 1.12.0, Patch: 3 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-aws-ebs-csi-driver) 
...
| [AWS EFS CSI Driver](/docs/satellite?topic=satellite-storage-aws-efs-csi-driver) | `aws-efs-csi-driver` | Version: 2.0.3 (Default), Patch: 1 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-aws-efs-csi-driver)  |
...
| [GCP Compute Persistent Disk CSI Driver](/docs/satellite?topic=satellite-storage-gcp-compute-persistent-disk-csi-driver) | `gcp-compute-persistent-disk-csi-driver` | Version: 1.7.1, Patch: 5 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-gcp-compute-persistent-disk-csi-driver) 
...
| [IBM Object Storage Plugin](/docs/satellite?topic=satellite-storage-ibm-object-storage-plugin) | `ibm-object-storage-plugin` | Version: 2.2 (Default), Patch: 37 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-object-storage-plugin)  |
...
| [IBM System Storage Block CSI driver](/docs/satellite?topic=satellite-storage-ibm-system-storage-block-csi-driver) | `ibm-system-storage-block-csi-driver` | Version: 1.11.1 (Default), Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-system-storage-block-csi-driver) 
| [IBM System Storage Block CSI driver](/docs/satellite?topic=satellite-storage-ibm-system-storage-block-csi-driver) | `ibm-system-storage-block-csi-driver` | Version: 1.11.2, Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-system-storage-block-csi-driver)  |
| [[Beta] IBM VPC Block CSI driver](/docs/satellite?topic=satellite-storage-ibm-vpc-block-csi-driver) | `ibm-vpc-block-csi-driver` | Version: 5.1 (Default), Patch: 15 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-vpc-block-csi-driver)  |
...
| [[Deprecated] Local Storage Operator - Block](/docs/satellite?topic=satellite-storage-local-volume-block) | `local-volume-block` | Version: 4.10, Patch: 4 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-block) 
| [[Deprecated] Local Storage Operator - Block](/docs/satellite?topic=satellite-storage-local-volume-block) | `local-volume-block` | Version: 4.11, Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-block) 
| [[Deprecated] Local Storage Operator - Block](/docs/satellite?topic=satellite-storage-local-volume-block) | `local-volume-block` | Version: 4.12, Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-block) 
| [[Deprecated] Local Storage Operator - Block](/docs/satellite?topic=satellite-storage-local-volume-block) | `local-volume-block` | Version: 4.13 (Default), Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-block)  |
...
| [[Deprecated] Local Storage Operator - File](/docs/satellite?topic=satellite-storage-local-volume-file) | `local-volume-file` | Version: 4.10, Patch: 4 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-file) 
| [[Deprecated] Local Storage Operator - File](/docs/satellite?topic=satellite-storage-local-volume-file) | `local-volume-file` | Version: 4.11, Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-file) 
| [[Deprecated] Local Storage Operator - File](/docs/satellite?topic=satellite-storage-local-volume-file) | `local-volume-file` | Version: 4.12, Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-file) 
| [[Deprecated] Local Storage Operator - File](/docs/satellite?topic=satellite-storage-local-volume-file) | `local-volume-file` | Version: 4.13 (Default), Patch: 1 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-local-volume-file)  |
...
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.15, Patch: 19 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.16 (Default), Patch: 14 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.17, Patch: 12 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.18, Patch: 8 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.19, Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.20, Patch: 3 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local)  |
...
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.13, Patch: 20 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.14, Patch: 18 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.15, Patch: 19 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.16 (Default), Patch: 14 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.17, Patch: 12 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.18, Patch: 8 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.19, Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.20, Patch: 3 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote)  |
| [VMware CSI Driver](/docs/satellite?topic=satellite-storage-vsphere-csi-driver) | `vsphere-csi-driver` | Version: 2.5.1, Patch: 6 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-vsphere-csi-driver) 
