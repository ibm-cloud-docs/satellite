...
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.16 (Default), Patch: 16 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
