...
| [IBM Object Storage Plugin](/docs/satellite?topic=satellite-storage-ibm-object-storage-plugin) | `ibm-object-storage-plugin` | Version: 2.2 (Default), Patch: 23 | Supported | [Change log](/docs/satellite?topic=satellite-cl-ibm-object-storage-plugin) 
...
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.12, Patch: 15 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.13, Patch: 12 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.14, Patch: 8 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.15 (Default), Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-local) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.12, Patch: 15 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.13, Patch: 12 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.14, Patch: 8 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.15 (Default), Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-odf-remote) 
