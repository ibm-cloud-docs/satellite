...
| [AWS EBS CSI Driver](/docs/satellite?topic=satellite-storage-aws-ebs-csi-driver) | `aws-ebs-csi-driver` | Version: 1.31.0 (Default), Patch: 1 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-aws-ebs-csi-driver)  |
...
| [IBM Object Storage Plugin](/docs/satellite?topic=satellite-storage-ibm-object-storage-plugin) | `ibm-object-storage-plugin` | Version: 2.2 (Default), Patch: 34 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-object-storage-plugin)  |
...
| [[Beta] IBM VPC Block CSI driver](/docs/satellite?topic=satellite-storage-ibm-vpc-block-csi-driver) | `ibm-vpc-block-csi-driver` | Version: 5.1 (Default), Patch: 13 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-ibm-vpc-block-csi-driver)  |
...
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.15, Patch: 16 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.16 (Default), Patch: 11 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.17, Patch: 9 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.18, Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local) 
| [OpenShift Data Foundation for local devices](/docs/satellite?topic=satellite-storage-odf-local) | `odf-local` | Version: 4.19, Patch: 2 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-local)  |
...
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.15, Patch: 16 | Deprecated | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.16 (Default), Patch: 11 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.17, Patch: 9 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.18, Patch: 5 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote) 
| [OpenShift Data Foundation for remote storage](/docs/satellite?topic=satellite-storage-odf-remote) | `odf-remote` | Version: 4.19, Patch: 2 | Supported | [Change log](/docs/satellite?topic=satellite-cl-storage-templates-odf-remote)  |
