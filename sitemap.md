...
* [Creating a secret that contains your {{site.data.keyword.satelliteshort}} Link credentials](/docs/satellite?topic=satellite-config-storage-ocs-local#odf-sat-link-local)
