...
{: #sitemap_managing_satellite_hosts}



## Preparing hosts to meet requirements
{: #sitemap_preparing_hosts_to_meet_requirements}
...
* [Cluster group commands](/docs/satellite?topic=satellite-satellite-cli-reference#group-commands)
  * [`ibmcloud sat group attach`](/docs/satellite?topic=satellite-satellite-cli-reference#group-attach)
  * [`ibmcloud sat group create`](/docs/satellite?topic=satellite-satellite-cli-reference#group-create)
  * [`ibmcloud sat group detach`](/docs/satellite?topic=satellite-satellite-cli-reference#group-detach)
  * [`ibmcloud sat group get`](/docs/satellite?topic=satellite-satellite-cli-reference#group-get)
  * [`ibmcloud sat group ls`](/docs/satellite?topic=satellite-satellite-cli-reference#group-ls)
  * [`ibmcloud sat group rm`](/docs/satellite?topic=satellite-satellite-cli-reference#group-rm)
...
[How can I get access to the {{site.data.keyword.satelliteshort}} beta?](/docs/satellite?topic=satellite-faqs#satellite-beta-access)
