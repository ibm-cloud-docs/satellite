...
# CoreOS enabled locations in Sao Paulo
...
Review the following outbound network requirements for RHEL and RHCOS hosts for use with CoreOS enabled locations in the (`br-sao`) region.
