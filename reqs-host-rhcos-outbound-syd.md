...
# CoreOS enabled locations in Sydney
...
Review the following outbound network requirements for RHEL and RHCOS hosts for use with CoreOS enabled locations in the Sydney (`au-syd`) region.
