...
# Sydney RHCOS host requirements
{: #reqs-host-rhcos-outbound-syd}

Review the following network requirements for outbound connectivity for Red Hat CoreOS (RHCOS) hosts for Red Hat CoreOS enabled locations in the Sydney (`au-syd`) region. 
{: shortdesc}
