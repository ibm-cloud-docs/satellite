...
After you set up your clusters to use with {{site.data.keyword.satelliteshort}} Config, verify the cluster status to make sure {{site.data.keyword.satelliteshort}} Config can deploy resources to them.
{: shortdesc}
