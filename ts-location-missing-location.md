...
2. From the command-line interface (CLI), [target the regional endpoint](/docs/openshift?topic=openshift-kubernetes-service-cli), such as Washington, D.C. (`us-east`) in the following example.
    ```sh
